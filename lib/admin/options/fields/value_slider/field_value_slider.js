jQuery(document).ready(function($){
	...
	/*
	 *
	 * bootstrap_basic_Options_value_slider function
	 * Adds a value slider functionality to the page
	 *
	 */
	 
  $(".bootstrap_basic-opts-value-slider").each(function() {
  		var $this = $(this),
  			...
  			$span = $('<span class="bootstrap_basic-opts-value-slider-description">'+value+unit+'</span>');
