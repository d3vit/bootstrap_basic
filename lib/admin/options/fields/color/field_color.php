<?php
class bootstrap_basic_Options_color extends bootstrap_basic_Options{	
	...
	*/
	function render(){
		...
		echo '<input type="text" id="'.$this->field['id'].'" name="'.$this->args['opt_name'].'['.$this->field['id'].']" value="'.$this->value.'" class="'.$class.' popup-colorpicker" style="width:75px;"/>';
